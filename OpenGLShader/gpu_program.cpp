...
void GPUProgram::DetectAttribute(const char* const& attributeName)
{
...
void GPUProgram::DetectUniform(const char* const& uniformName)
{
...
GLint GPUProgram::GetLocation(const char* const& name)
{
